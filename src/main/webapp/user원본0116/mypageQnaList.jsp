...
<tr><td><a class = "page_box"><%=currentPage %>/<%=pageCount %>페이지(전체<%=count %>) </a></td></tr>
	<tr align ="center">
		<th>번호</th>
		<th width="100">글쓴이</th>
		<th width="500">제목</th>
...
%>
	<a href="UserQnaList.us?pageNum=<%=startPage-pageBlock %>">[10이전]</a>
<%
}else {
	%>
	<a href="UserQnaList.us?pageNum=<%=startPage %>">[10이전]</a>
<%
}
// 1페이지 이전
if(currentPage != 1) {
...
%>
	<a href="UserQnaList.us?pageNum=<%=i%>"><%=i%></a>
<%
} 
...
if(endPage < pageCount) {
	%>
	<a href="UserQnaList.us?pageNum=<%=startPage+pageBlock %>">[10다음]</a>
	<%
} else {
	%>
	<a href="UserQnaList.us?pageNum=<%=endPage %>">[10다음]</a>
<%
}
%>
<br>
